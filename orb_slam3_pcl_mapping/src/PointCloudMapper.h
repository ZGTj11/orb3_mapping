...
namespace Mapping {
    ...
    protected:
        ...
        std::vector<Eigen::Isometry3f,Eigen::aligned_allocator<Eigen::Isometry3f>> mvGlobalPointCloudsPose; //所有关键帧的位姿
        //std::vector<Eigen::Isometry3f,Eigen::aligned_allocator<Eigen::Isometry3f>> mvGlobalPointCloudsPose; 
	    ...
	    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, sensor_msgs::Image, geometry_msgs::PoseStamped, nav_msgs::Path> ApproximateSyncPolicy;
        ros::NodeHandle nh;
